        ...
        >
          ...
          <Flex justifyContent="center">
            <Box borderRadius={10}
              color={"black"}
              zIndex={100}
              className="advancedSearch" bg="lightgreen" w="max-content" align="center" padding="5px 15px"><Link to={"/interests"}><Text fontWeight={"bold"}> Advanced Search </Text></Link></Box>
          </Flex>
        </Stack>
      </Box>
    </>
